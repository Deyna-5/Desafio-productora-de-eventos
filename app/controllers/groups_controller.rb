class GroupsController < ApplicationController
  ...
  def create
    ...
    if @group.save
      redirect_to groups_path, notice: "Grupo añadido éxitosamente"
    else
      redirect_to new_group_path, notice: "El grupo no se pudo añadir, intente nuevamente"
    end
  end
  ...
  def update
    ...
    redirect_to root_path, notice: "Grupo editado éxitosamente"
  end
